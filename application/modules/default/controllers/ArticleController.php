...
class ArticleController extends Zend_Controller_Action
{
    ...
    public function showAction()
    {
        ...
        $this->view->mass = Application_Model_Kernel_Article::getByIdPage($this->view->idPage);
    ...
    public function indexAction()
    {
        ...
        $this->view->articles = Application_Model_Kernel_Article::getList(false, false, true, true, false, false, $this->view->page, 15, false, true, false);

        if ($this->view->page == 1) {
            $this->view->headText = "<link rel='next' href='/articles/page".($this->view->page+1).".html' />";
        } else {
            if ($this->view->page == 2)
                $this->view->headText = "<link rel='prev' href='/articles/' />";
            else
                $this->view->headText = "<link rel='prev' href='/articles/page".($this->view->page-1).".html' />";
            $this->view->headText .=  "<link rel='next' href='/articles/page".($this->view->page+1).".html' />
