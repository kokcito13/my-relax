...
class VacancyController extends Zend_Controller_Action
{
    ...
    public function showAction()
    {
        ...
        $this->view->discount = Application_Model_Kernel_Vacancy::getByIdPage($this->view->idPage);
    ...
    public function indexAction()
    {
        ...
        $this->view->items = Application_Model_Kernel_Vacancy::getList(false, false, true, true, false, false, $this->view->page, 15, false, true, $where);

        if ($this->view->page == 1) {
            $this->view->headText = "<link rel='next' href='/vakansii/page".($this->view->page+1).".html' />";
        } else {
            if ($this->view->page == 2)
                $this->view->headText = "<link rel='prev' href='/vakansii/' />";
            else
                $this->view->headText = "<link rel='prev' href='/vakansii/page".($this->view->page-1).".html' />";
            $this->view->headText .=  "<link rel='next' href='/vakansii/page".($this->view->page+1).".html' />
