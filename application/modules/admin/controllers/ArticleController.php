...
class Admin_ArticleController extends Zend_Controller_Action
{
    ...
    public function preDispatch()
    {
        ...
        $this->view->headTitle()->append('Список Статей');
    }

    public function indexAction()
    {
        $this->view->add = (object)array(
            'link' => $this->view->url(array(), 'admin-article-add'),
            'alt'  => 'Добавить',
            'text' => 'Добавить'
        );
        ...
        $this->view->breadcrumbs->add('Список статей', '');
        $this->view->headTitle()->append('Список статей');
        $this->view->masses = Application_Model_Kernel_Article::getList(false, false, true, true, false, false, $this->view->page, 15, false, true, false);
    }
    ...
    public function addAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            try {
                ...
                $url = new Application_Model_Kernel_Routing_Url("/articles/".$data->url.'.html');
                $defaultParams = new Application_Model_Kernel_Routing_DefaultParams();
                $route = new Application_Model_Kernel_Routing(null, Application_Model_Kernel_Routing::TYPE_ROUTE, '~public', 'default', 'article', 'show', $url, $defaultParams, Application_Model_Kernel_Routing::STATUS_ACTIVE);
                ...
                $this->view->mass = new Application_Model_Kernel_Article(null,
                                                                        $this->view->idPhoto1,
                                                                        null, null, null,
                ...
                $this->_redirect($this->view->url(array('page' => 1), 'admin-article-index'));
    ...
    public function editAction()
    {
        ...
        $this->view->tinymce = true;
        $this->view->edit = true;
        $this->view->mass = Application_Model_Kernel_Article::getById((int)$this->_getParam('id'));
        ...
        if ($this->getRequest()->isPost()) {
            ...
            try {
                ...
                $this->view->mass->getRoute()->setUrl('/articles/'.$data->url.'.html');
